package com.bick.com.shoppingmodel.adapter.adapter;
...
import com.bick.com.shoppingmodel.adapter.view.UIAlertView;
...
public class MyExpandableListAdapter extends BaseExpandableListAdapter {
    ...
    View.OnClickListener listener = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            } else if (i1 == R.id.llGoodInfo) {
                ToastHelper.getInstance()._toast("商品详情，暂未实现");

            } else if (i1 == R.id.tvShopNameGroup) {
